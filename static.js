function initMap() {
    ...
    // This is a set of pages with options for each page		
      ...
      pages: [
...

        {
          ...
          {
            id: "63e2c167950549ba5452a91b",
            href: "http://127.0.0.1:5500/redy/index.html",
            urlImgMarker: "https://floridakeyspass.com/wp-content/uploads/2022/07/Scuba-Diver.png",
            private: true,
            bangalore: {
              lat: 24.559926,
    ...
    async function getPagesRequest() {
        await fetch("https://static-pjfv.onrender.com/api/get-pages-data")
          .then((res) => res.json())
  ...
  let isPrivate = false
    function init() {
      ...
      if (dataPages.private) {
        dataMap.general.allMarkers = false;
        isPrivate = true
      } else {
        isPrivate = false
        dataMap.general.allMarkers = true;
      }
